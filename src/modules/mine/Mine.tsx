...
export default observer(() => {
    ...
    const [noteList,setNoteList] = useState<ArticleSimple[]>([]);
    const [collectionList,setCollectionList] = useState<ArticleSimple[]>([]);
    const [favorateList,setFavorateList] = useState<ArticleSimple[]>([]);
    ...
    const requestNoteList = useCallback(async () => {
        try {
    ...
    const requestFavorateList = useCallback(async () => {
        try {
